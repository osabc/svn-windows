...
if not exist cyrus-sasl-2.1.27.zip appveyor DownloadFile https://github.com/cyrusimap/cyrus-sasl/archive/refs/tags/cyrus-sasl-2.1.27.zip
if     exist cyrus-sasl-2.1.27.zip 7z x -y cyrus-sasl-2.1.27.zip
